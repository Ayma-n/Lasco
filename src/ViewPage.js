    ...
    <div id="ViewPage">
      ...
      <div id="modal">
        ...
        <div className="centered">
          ...
          <div id="description">Lucious greens and blues drawn in Procreate.</div>
          <div id="priceAndBuy">
          ...
          <div id="commentSec">
            <div className="profileImgDiv">
              ...
              <div className="commentText">
                ...
                it up! Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur vel maiores aut qui voluptas atque laboriosam ullam debitis ad nisi fugiat sunt quia, dolores aliquam iure harum numquam eaque, doloremque ducimus, quae cumque obcaecati! Ipsa nulla nobis voluptatem. Voluptas, numquam blanditiis quod repudiandae velit ad. Eos repellat ipsa enim assumenda ea. Perspiciatis exercitationem eligendi.
              </div>
            <div className="profileImgDiv">
              <img src={profileImg} alt="profile" className="profileImg" />
              </div>
